...
StandardUrlDomVisitorProvider::StandardUrlDomVisitorProvider(Configuration *configuration)
        : m_ignoreLinks{std::make_unique<StandardUrlExpander>(QRegularExpression{QStringLiteral("\\b(http://|https://|www\\.|ftp://)([^\\s\\\\]*)"), QRegularExpression::UseUnicodePropertiesOption})},
